...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description='get list of vpn accounts to expire')
    parser.add_argument(
        '--graduates', required=True, type=str, help='path to csv of graduate user ids')
    parser.add_argument('--college_leave', required=True,
                        type=str, help='path to csv of college leave user ids')
    parser.add_argument(
        '--vpn_accounts', required=True, type=str, help='path to csv of vpn user ids')
    parser.add_argument(
        '--output_file', required=True, type=str, help='name of outputfile')
